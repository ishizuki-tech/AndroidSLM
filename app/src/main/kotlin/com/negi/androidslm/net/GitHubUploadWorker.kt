...
class GitHubUploadWorker(
     ...
     * Example: `"exports" + "data.json"` → `"exports/data.json"`
     */
    ...
    // -----------------------------------------------------------------
    // ⚙️ Companion Object: Constants & Enqueue Utilities
    // -----------------------------------------------------------------
    companion object {
         ...
         *
         * If a file with the same name already exists, a unique suffix (`_1`, `_2`, …)
        ...
        /**
         * If the specified file already exists, appends a numeric suffix (`_1`, `_2`, …)
